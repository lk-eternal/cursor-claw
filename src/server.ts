...
const mcpServer = new McpServer({ name: "cursor-claw", version: PKG_VERSION, description: "消息桥接 – 通过飞书/微信与用户沟通" });
...
export async function main(): Promise<void> {
  ...
  log("INFO", "════════════════════════════════════════════════");
  log("INFO", `cursor-claw MCP v${PKG_VERSION} 启动 (PID=${process.pid})`);
